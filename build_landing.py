...
PRODUCTS = [
    ...
    {"id":"transport", "name":"בקרה ואופטימיזציה של תקציבי הסעות",          "rgb":"70,154,128",  "live":False,
     "desc":'פלטפורמה מקצה-לקצה לתכנון ואופטימיזציה של מערך ההסעות ברשות: איחוד מסלולים חכם, זמני נסיעה אמיתיים מבוססי תנועה, ושקיפות מלאה של כל חישוב והחלטה. הכל במקום אחד, בהתאמה לצרכי השלטון המקומי.<br>המערכת מזהה אוטומטית אילו תלמידים ניתן לאחד — תוך שמירה קפדנית על זמן הנסיעה של כל ילד, על הליווי ועל הצרכים האישיים — ומציגה בכל רגע כמה זה חוסך בפועל: פחות רכבים, פחות מלווים, יותר שליטה.'},
