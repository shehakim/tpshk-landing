...
NODE_POS = [
    [45, 20],  # ניהול כח אדם (ארוך) — מרכז, עליון
    [65, 23],  # בניית תקציב         — ימין, עליון
    [78, 39],  # ניהול תיכונים       — ימין, עליון-אמצע
    [78, 61],  # הסעות (ארוך)        — ימין, תחתון-אמצע
    [65, 77],  # פקודת יומן          — ימין, תחתון
    [45, 81],  # אגרות חוץ           — מרכז, תחתון
    [27, 70],  # בקרת כח אדם         — שמאל, תחתון
    [20, 50],  # שכר תיכונים (ארוך)  — שמאל, אמצע
    [27, 30],  # אבטחת מוסדות חינוך  — שמאל, עליון
]
...
MOBILE_NODE_POS = [
    ...
    [85, 43],  # ימין
    [80, 69],  # תחתון-ימין
    [62, 86],  # תחתון-ימין נמוך
    [38, 86],  # תחתון-שמאל נמוך
    [20, 69],  # תחתון-שמאל
    [15, 43],  # שמאל
    [27, 21],  # עליון-שמאל
]
