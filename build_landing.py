...
NODE_POS = [
    ...
    [79, 41],  # שעות הוראה          — ימין, עליון-אמצע
    [79, 60],  # הסעות (ארוך)        — ימין, תחתון-אמצע
    [68, 76],  # פקודת יומן          — ימין, תחתון
    [50, 82],  # אגרות חוץ           — מרכז, תחתון
    [32, 76],  # שכר הוראה           — שמאל, תחתון
    [21, 60],  # אבטחת מוסדות חינוך  — שמאל, תחתון-אמצע
    [21, 41],  # מיפוי חנ״מ          — שמאל, עליון-אמצע
    [32, 25],  # בקרת תכנית ניצנים   — שמאל, עליון
]
